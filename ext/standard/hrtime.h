...
#define PHP_HRTIME_PLATFORM_VMS     0
...
#ifdef __VMS
#undef PHP_HRTIME_PLATFORM_VMS
#define PHP_HRTIME_PLATFORM_VMS 1
#endif

#define HRTIME_AVAILABLE (PHP_HRTIME_PLATFORM_POSIX || PHP_HRTIME_PLATFORM_WINDOWS || PHP_HRTIME_PLATFORM_APPLE || PHP_HRTIME_PLATFORM_HPUX || PHP_HRTIME_PLATFORM_AIX || PHP_HRTIME_PLATFORM_VMS)
