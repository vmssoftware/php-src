...
/* Whether to build zmq as a dynamic module */
#define COMPILE_DL_ZMQ 1

/* Whether to build openvms as dynamic module */
#define COMPILE_DL_OPENVMS 1
...
/* Whether you have openvms */
#define HAVE_OPENVMS 1
...
#define HAVE_FLOCK_LINUX /* This is correct for __VMS */
...
/* */
#define HAVE_XSL_EXSLT 1	/* Should be okay; BRC */
...
/* Currently only support pre-0x0300, so un-define this */
...
/* uname -a output */
#define PHP_UNAME "Linux inspiron 3.13.0-55-generic #92-Ubuntu SMP Sun Jun 14 18:32:20 UTC 2015 x86_64 x86_64 x86_64 GNU/Linux"
...
typedef int ptrdiff_t;	/* OpenVMS, 32-bit pointers */
...
/* All extensions (shareable images) will be prefixed with this. */
#define PHP_EXTENSION_PREFIX ""
// #define PHP_EXTENSION_PREFIX "php$"
...
#ifndef timercmp
/* does not work for >= and <= */       /* Not sure about this (BRC 21-Jun-2015 ) */
